...
.PHONY: feeds_bundesarchiv
feeds_bundesarchiv: ## Generate RSS feed for Bundesarchiv Aktuelles
	$(call check_venv)
	$(call print_info,Generating Bundesarchiv feed)
	$(Q)uv run feed_generators/bundesarchiv_blog.py
	$(call print_success,Bundesarchiv feed generated)
